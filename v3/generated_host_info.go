...
func newHostInfoClient(kuladoClient *KuladoClient) *HostInfoClient {
...
func (c *HostInfoClient) Create(container *HostInfo) (*HostInfo, error) {
	resp := &HostInfo{}
	err := c.kuladoClient.doCreate(HOST_INFO_TYPE, container, resp)
	return resp, err
}

func (c *HostInfoClient) Update(existing *HostInfo, updates interface{}) (*HostInfo, error) {
	resp := &HostInfo{}
	err := c.kuladoClient.doUpdate(HOST_INFO_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *HostInfoClient) List(opts *ListOpts) (*HostInfoCollection, error) {
	resp := &HostInfoCollection{}
	err := c.kuladoClient.doList(HOST_INFO_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *HostInfoClient) ById(id string) (*HostInfo, error) {
	resp := &HostInfo{}
	err := c.kuladoClient.doById(HOST_INFO_TYPE, id, resp)
...
func (c *HostInfoClient) Delete(container *HostInfo) error {
	return c.kuladoClient.doResourceDelete(HOST_INFO_TYPE, &container.Resource)
}
