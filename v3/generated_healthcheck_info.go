...
func newHealthcheckInfoClient(kuladoClient *KuladoClient) *HealthcheckInfoClient {
...
func (c *HealthcheckInfoClient) ById(id string) (*HealthcheckInfo, error) {
	resp := &HealthcheckInfo{}
	err := c.kuladoClient.doById(HEALTHCHECK_INFO_TYPE, id, resp)
...
func (c *HealthcheckInfoClient) Delete(container *HealthcheckInfo) error {
	return c.kuladoClient.doResourceDelete(HEALTHCHECK_INFO_TYPE, &container.Resource)
}
