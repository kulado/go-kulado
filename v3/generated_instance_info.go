...
func newInstanceInfoClient(kuladoClient *KuladoClient) *InstanceInfoClient {
...
func (c *InstanceInfoClient) Create(container *InstanceInfo) (*InstanceInfo, error) {
	resp := &InstanceInfo{}
	err := c.kuladoClient.doCreate(INSTANCE_INFO_TYPE, container, resp)
	return resp, err
}

func (c *InstanceInfoClient) Update(existing *InstanceInfo, updates interface{}) (*InstanceInfo, error) {
	resp := &InstanceInfo{}
	err := c.kuladoClient.doUpdate(INSTANCE_INFO_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *InstanceInfoClient) List(opts *ListOpts) (*InstanceInfoCollection, error) {
	resp := &InstanceInfoCollection{}
	err := c.kuladoClient.doList(INSTANCE_INFO_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *InstanceInfoClient) ById(id string) (*InstanceInfo, error) {
	resp := &InstanceInfo{}
	err := c.kuladoClient.doById(INSTANCE_INFO_TYPE, id, resp)
...
func (c *InstanceInfoClient) Delete(container *InstanceInfo) error {
	return c.kuladoClient.doResourceDelete(INSTANCE_INFO_TYPE, &container.Resource)
}
