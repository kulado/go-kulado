...
func (c *DnsServiceClient) ActionError(resource *DnsService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(DNS_SERVICE_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *DnsServiceClient) ActionGarbagecollect(resource *DnsService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(DNS_SERVICE_TYPE, "garbagecollect", &resource.Resource, nil, resp)
...
func (c *DnsServiceClient) ActionPause(resource *DnsService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(DNS_SERVICE_TYPE, "pause", &resource.Resource, nil, resp)
...
func (c *DnsServiceClient) ActionRestart(resource *DnsService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(DNS_SERVICE_TYPE, "restart", &resource.Resource, nil, resp)
...
func (c *DnsServiceClient) ActionRollback(resource *DnsService, input *ServiceRollback) (*Service, error) {
	...
	err := c.kuladoClient.doAction(DNS_SERVICE_TYPE, "rollback", &resource.Resource, input, resp)
