...
func newServiceInfoClient(kuladoClient *KuladoClient) *ServiceInfoClient {
...
func (c *ServiceInfoClient) Create(container *ServiceInfo) (*ServiceInfo, error) {
	resp := &ServiceInfo{}
	err := c.kuladoClient.doCreate(SERVICE_INFO_TYPE, container, resp)
	return resp, err
}

func (c *ServiceInfoClient) Update(existing *ServiceInfo, updates interface{}) (*ServiceInfo, error) {
	resp := &ServiceInfo{}
	err := c.kuladoClient.doUpdate(SERVICE_INFO_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *ServiceInfoClient) List(opts *ListOpts) (*ServiceInfoCollection, error) {
	resp := &ServiceInfoCollection{}
	err := c.kuladoClient.doList(SERVICE_INFO_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *ServiceInfoClient) ById(id string) (*ServiceInfo, error) {
	resp := &ServiceInfo{}
	err := c.kuladoClient.doById(SERVICE_INFO_TYPE, id, resp)
...
func (c *ServiceInfoClient) Delete(container *ServiceInfo) error {
	return c.kuladoClient.doResourceDelete(SERVICE_INFO_TYPE, &container.Resource)
}
