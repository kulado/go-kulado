...
func newDeploymentUnitClient(kuladoClient *KuladoClient) *DeploymentUnitClient {
...
func (c *DeploymentUnitClient) ById(id string) (*DeploymentUnit, error) {
	resp := &DeploymentUnit{}
	err := c.kuladoClient.doById(DEPLOYMENT_UNIT_TYPE, id, resp)
...
func (c *DeploymentUnitClient) Delete(container *DeploymentUnit) error {
	return c.kuladoClient.doResourceDelete(DEPLOYMENT_UNIT_TYPE, &container.Resource)
}
...
func (c *DeploymentUnitClient) ActionActivate(resource *DeploymentUnit) (*DeploymentUnit, error) {
	...
	err := c.kuladoClient.doAction(DEPLOYMENT_UNIT_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *DeploymentUnitClient) ActionCreate(resource *DeploymentUnit) (*DeploymentUnit, error) {
	...
	err := c.kuladoClient.doAction(DEPLOYMENT_UNIT_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *DeploymentUnitClient) ActionDeactivate(resource *DeploymentUnit) (*DeploymentUnit, error) {
	...
	err := c.kuladoClient.doAction(DEPLOYMENT_UNIT_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *DeploymentUnitClient) ActionError(resource *DeploymentUnit) (*DeploymentUnit, error) {
	...
	err := c.kuladoClient.doAction(DEPLOYMENT_UNIT_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *DeploymentUnitClient) ActionPause(resource *DeploymentUnit) (*DeploymentUnit, error) {
	...
	err := c.kuladoClient.doAction(DEPLOYMENT_UNIT_TYPE, "pause", &resource.Resource, nil, resp)
...
func (c *DeploymentUnitClient) ActionRemove(resource *DeploymentUnit) (*DeploymentUnit, error) {
	...
	err := c.kuladoClient.doAction(DEPLOYMENT_UNIT_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *DeploymentUnitClient) ActionUpdate(resource *DeploymentUnit) (*DeploymentUnit, error) {
	...
	err := c.kuladoClient.doAction(DEPLOYMENT_UNIT_TYPE, "update", &resource.Resource, nil, resp)
