...
func newServiceLogClient(kuladoClient *KuladoClient) *ServiceLogClient {
...
func (c *ServiceLogClient) Create(container *ServiceLog) (*ServiceLog, error) {
	resp := &ServiceLog{}
	err := c.kuladoClient.doCreate(SERVICE_LOG_TYPE, container, resp)
	return resp, err
}

func (c *ServiceLogClient) Update(existing *ServiceLog, updates interface{}) (*ServiceLog, error) {
	resp := &ServiceLog{}
	err := c.kuladoClient.doUpdate(SERVICE_LOG_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *ServiceLogClient) List(opts *ListOpts) (*ServiceLogCollection, error) {
	resp := &ServiceLogCollection{}
	err := c.kuladoClient.doList(SERVICE_LOG_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *ServiceLogClient) ById(id string) (*ServiceLog, error) {
	resp := &ServiceLog{}
	err := c.kuladoClient.doById(SERVICE_LOG_TYPE, id, resp)
...
func (c *ServiceLogClient) Delete(container *ServiceLog) error {
	return c.kuladoClient.doResourceDelete(SERVICE_LOG_TYPE, &container.Resource)
}
