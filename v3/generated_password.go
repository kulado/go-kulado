...
func newPasswordClient(kuladoClient *KuladoClient) *PasswordClient {
...
func (c *PasswordClient) Create(container *Password) (*Password, error) {
	resp := &Password{}
	err := c.kuladoClient.doCreate(PASSWORD_TYPE, container, resp)
	return resp, err
}

func (c *PasswordClient) Update(existing *Password, updates interface{}) (*Password, error) {
	resp := &Password{}
	err := c.kuladoClient.doUpdate(PASSWORD_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *PasswordClient) List(opts *ListOpts) (*PasswordCollection, error) {
	resp := &PasswordCollection{}
	err := c.kuladoClient.doList(PASSWORD_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *PasswordClient) ById(id string) (*Password, error) {
	resp := &Password{}
	err := c.kuladoClient.doById(PASSWORD_TYPE, id, resp)
...
func (c *PasswordClient) Delete(container *Password) error {
	return c.kuladoClient.doResourceDelete(PASSWORD_TYPE, &container.Resource)
}
...
func (c *PasswordClient) ActionActivate(resource *Password) (*Credential, error) {
	...
	err := c.kuladoClient.doAction(PASSWORD_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *PasswordClient) ActionChangesecret(resource *Password, input *ChangeSecretInput) (*ChangeSecretInput, error) {
	...
	err := c.kuladoClient.doAction(PASSWORD_TYPE, "changesecret", &resource.Resource, input, resp)
...
func (c *PasswordClient) ActionCreate(resource *Password) (*Credential, error) {
	...
	err := c.kuladoClient.doAction(PASSWORD_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *PasswordClient) ActionDeactivate(resource *Password) (*Credential, error) {
	...
	err := c.kuladoClient.doAction(PASSWORD_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *PasswordClient) ActionRemove(resource *Password) (*Credential, error) {
	...
	err := c.kuladoClient.doAction(PASSWORD_TYPE, "remove", &resource.Resource, nil, resp)
