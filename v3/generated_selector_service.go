...
func newSelectorServiceClient(kuladoClient *KuladoClient) *SelectorServiceClient {
...
func (c *SelectorServiceClient) ById(id string) (*SelectorService, error) {
	resp := &SelectorService{}
	err := c.kuladoClient.doById(SELECTOR_SERVICE_TYPE, id, resp)
...
func (c *SelectorServiceClient) Delete(container *SelectorService) error {
	return c.kuladoClient.doResourceDelete(SELECTOR_SERVICE_TYPE, &container.Resource)
}
...
func (c *SelectorServiceClient) ActionActivate(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionCancelupgrade(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "cancelupgrade", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionCreate(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionDeactivate(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionError(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionFinishupgrade(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "finishupgrade", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionGarbagecollect(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "garbagecollect", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionPause(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "pause", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionRemove(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionRestart(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "restart", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionRollback(resource *SelectorService, input *ServiceRollback) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "rollback", &resource.Resource, input, resp)
...
func (c *SelectorServiceClient) ActionUpdate(resource *SelectorService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "update", &resource.Resource, nil, resp)
...
func (c *SelectorServiceClient) ActionUpgrade(resource *SelectorService, input *ServiceUpgrade) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SELECTOR_SERVICE_TYPE, "upgrade", &resource.Resource, input, resp)
