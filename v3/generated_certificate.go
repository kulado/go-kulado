...
func newCertificateClient(kuladoClient *KuladoClient) *CertificateClient {
...
func (c *CertificateClient) Create(container *Certificate) (*Certificate, error) {
	resp := &Certificate{}
	err := c.kuladoClient.doCreate(CERTIFICATE_TYPE, container, resp)
	return resp, err
}

func (c *CertificateClient) Update(existing *Certificate, updates interface{}) (*Certificate, error) {
	resp := &Certificate{}
	err := c.kuladoClient.doUpdate(CERTIFICATE_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *CertificateClient) List(opts *ListOpts) (*CertificateCollection, error) {
	resp := &CertificateCollection{}
	err := c.kuladoClient.doList(CERTIFICATE_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *CertificateClient) ById(id string) (*Certificate, error) {
	resp := &Certificate{}
	err := c.kuladoClient.doById(CERTIFICATE_TYPE, id, resp)
...
func (c *CertificateClient) Delete(container *Certificate) error {
	return c.kuladoClient.doResourceDelete(CERTIFICATE_TYPE, &container.Resource)
}
...
func (c *CertificateClient) ActionCreate(resource *Certificate) (*Certificate, error) {
	...
	err := c.kuladoClient.doAction(CERTIFICATE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *CertificateClient) ActionRemove(resource *Certificate) (*Certificate, error) {
	...
	err := c.kuladoClient.doAction(CERTIFICATE_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *CertificateClient) ActionUpdate(resource *Certificate) (*Certificate, error) {
	...
	err := c.kuladoClient.doAction(CERTIFICATE_TYPE, "update", &resource.Resource, nil, resp)
