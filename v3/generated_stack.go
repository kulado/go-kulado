...
func (c *StackClient) ActionPause(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "pause", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionStartall(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "startall", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionStopall(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "stopall", &resource.Resource, nil, resp)
