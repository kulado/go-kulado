...
func newKubernetesServiceClient(kuladoClient *KuladoClient) *KubernetesServiceClient {
...
func (c *KubernetesServiceClient) ById(id string) (*KubernetesService, error) {
	resp := &KubernetesService{}
	err := c.kuladoClient.doById(KUBERNETES_SERVICE_TYPE, id, resp)
...
func (c *KubernetesServiceClient) Delete(container *KubernetesService) error {
	return c.kuladoClient.doResourceDelete(KUBERNETES_SERVICE_TYPE, &container.Resource)
}
...
func (c *KubernetesServiceClient) ActionActivate(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionCancelupgrade(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "cancelupgrade", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionCreate(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionDeactivate(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionError(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionFinishupgrade(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "finishupgrade", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionGarbagecollect(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "garbagecollect", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionPause(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "pause", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionRemove(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionRestart(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "restart", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionRollback(resource *KubernetesService, input *ServiceRollback) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "rollback", &resource.Resource, input, resp)
...
func (c *KubernetesServiceClient) ActionUpdate(resource *KubernetesService) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "update", &resource.Resource, nil, resp)
...
func (c *KubernetesServiceClient) ActionUpgrade(resource *KubernetesService, input *ServiceUpgrade) (*Service, error) {
	...
	err := c.kuladoClient.doAction(KUBERNETES_SERVICE_TYPE, "upgrade", &resource.Resource, input, resp)
