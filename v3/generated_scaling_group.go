...
func newScalingGroupClient(kuladoClient *KuladoClient) *ScalingGroupClient {
...
func (c *ScalingGroupClient) Create(container *ScalingGroup) (*ScalingGroup, error) {
	resp := &ScalingGroup{}
	err := c.kuladoClient.doCreate(SCALING_GROUP_TYPE, container, resp)
	return resp, err
}

func (c *ScalingGroupClient) Update(existing *ScalingGroup, updates interface{}) (*ScalingGroup, error) {
	resp := &ScalingGroup{}
	err := c.kuladoClient.doUpdate(SCALING_GROUP_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *ScalingGroupClient) List(opts *ListOpts) (*ScalingGroupCollection, error) {
	resp := &ScalingGroupCollection{}
	err := c.kuladoClient.doList(SCALING_GROUP_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *ScalingGroupClient) ById(id string) (*ScalingGroup, error) {
	resp := &ScalingGroup{}
	err := c.kuladoClient.doById(SCALING_GROUP_TYPE, id, resp)
...
func (c *ScalingGroupClient) Delete(container *ScalingGroup) error {
	return c.kuladoClient.doResourceDelete(SCALING_GROUP_TYPE, &container.Resource)
}
...
func (c *ScalingGroupClient) ActionActivate(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionCancelupgrade(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "cancelupgrade", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionCreate(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionDeactivate(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionError(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionFinishupgrade(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "finishupgrade", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionGarbagecollect(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "garbagecollect", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionPause(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "pause", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionRemove(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionRestart(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "restart", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionRollback(resource *ScalingGroup, input *ServiceRollback) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "rollback", &resource.Resource, input, resp)
...
func (c *ScalingGroupClient) ActionUpdate(resource *ScalingGroup) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "update", &resource.Resource, nil, resp)
...
func (c *ScalingGroupClient) ActionUpgrade(resource *ScalingGroup, input *ServiceUpgrade) (*Service, error) {
	...
	err := c.kuladoClient.doAction(SCALING_GROUP_TYPE, "upgrade", &resource.Resource, input, resp)
