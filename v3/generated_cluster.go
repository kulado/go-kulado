...
func newClusterClient(kuladoClient *KuladoClient) *ClusterClient {
...
func (c *ClusterClient) Create(container *Cluster) (*Cluster, error) {
	resp := &Cluster{}
	err := c.kuladoClient.doCreate(CLUSTER_TYPE, container, resp)
	return resp, err
}

func (c *ClusterClient) Update(existing *Cluster, updates interface{}) (*Cluster, error) {
	resp := &Cluster{}
	err := c.kuladoClient.doUpdate(CLUSTER_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *ClusterClient) List(opts *ListOpts) (*ClusterCollection, error) {
	resp := &ClusterCollection{}
	err := c.kuladoClient.doList(CLUSTER_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *ClusterClient) ById(id string) (*Cluster, error) {
	resp := &Cluster{}
	err := c.kuladoClient.doById(CLUSTER_TYPE, id, resp)
...
func (c *ClusterClient) Delete(container *Cluster) error {
	return c.kuladoClient.doResourceDelete(CLUSTER_TYPE, &container.Resource)
}
...
func (c *ClusterClient) ActionActivate(resource *Cluster) (*Cluster, error) {
	...
	err := c.kuladoClient.doAction(CLUSTER_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *ClusterClient) ActionCreate(resource *Cluster) (*Cluster, error) {
	...
	err := c.kuladoClient.doAction(CLUSTER_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *ClusterClient) ActionError(resource *Cluster) (*Cluster, error) {
	...
	err := c.kuladoClient.doAction(CLUSTER_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *ClusterClient) ActionRemove(resource *Cluster) (*Cluster, error) {
	...
	err := c.kuladoClient.doAction(CLUSTER_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *ClusterClient) ActionUpdate(resource *Cluster) (*Cluster, error) {
	...
	err := c.kuladoClient.doAction(CLUSTER_TYPE, "update", &resource.Resource, nil, resp)
