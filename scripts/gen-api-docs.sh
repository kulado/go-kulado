...
#go run *.go -command=generate-docs -version=v1.3 -lang=en -layout=kulado-api-v1-default-v1.3 -apiVersion=v1
go run *.go -command=generate-docs -version=v1.3 -lang=en -layout=kulado-api-v2-beta-default-v1.3 -apiVersion=v2-beta
