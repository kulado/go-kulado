...
func newQuestionClient(kuladoClient *KuladoClient) *QuestionClient {
...
func (c *QuestionClient) Create(container *Question) (*Question, error) {
	resp := &Question{}
	err := c.kuladoClient.doCreate(QUESTION_TYPE, container, resp)
	return resp, err
}

func (c *QuestionClient) Update(existing *Question, updates interface{}) (*Question, error) {
	resp := &Question{}
	err := c.kuladoClient.doUpdate(QUESTION_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *QuestionClient) List(opts *ListOpts) (*QuestionCollection, error) {
	resp := &QuestionCollection{}
	err := c.kuladoClient.doList(QUESTION_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *QuestionClient) ById(id string) (*Question, error) {
	resp := &Question{}
	err := c.kuladoClient.doById(QUESTION_TYPE, id, resp)
...
func (c *QuestionClient) Delete(container *Question) error {
	return c.kuladoClient.doResourceDelete(QUESTION_TYPE, &container.Resource)
}
