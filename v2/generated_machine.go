...
func newMachineClient(kuladoClient *KuladoClient) *MachineClient {
...
func (c *MachineClient) Create(container *Machine) (*Machine, error) {
	resp := &Machine{}
	err := c.kuladoClient.doCreate(MACHINE_TYPE, container, resp)
	return resp, err
}

func (c *MachineClient) Update(existing *Machine, updates interface{}) (*Machine, error) {
	resp := &Machine{}
	err := c.kuladoClient.doUpdate(MACHINE_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *MachineClient) List(opts *ListOpts) (*MachineCollection, error) {
	resp := &MachineCollection{}
	err := c.kuladoClient.doList(MACHINE_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *MachineClient) ById(id string) (*Machine, error) {
	resp := &Machine{}
	err := c.kuladoClient.doById(MACHINE_TYPE, id, resp)
...
func (c *MachineClient) Delete(container *Machine) error {
	return c.kuladoClient.doResourceDelete(MACHINE_TYPE, &container.Resource)
}
...
func (c *MachineClient) ActionBootstrap(resource *Machine) (*PhysicalHost, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_TYPE, "bootstrap", &resource.Resource, nil, resp)
...
func (c *MachineClient) ActionCreate(resource *Machine) (*PhysicalHost, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *MachineClient) ActionError(resource *Machine) (*PhysicalHost, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *MachineClient) ActionRemove(resource *Machine) (*PhysicalHost, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *MachineClient) ActionUpdate(resource *Machine) (*PhysicalHost, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_TYPE, "update", &resource.Resource, nil, resp)
