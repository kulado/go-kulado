...
func newComposeProjectClient(kuladoClient *KuladoClient) *ComposeProjectClient {
...
func (c *ComposeProjectClient) ById(id string) (*ComposeProject, error) {
	resp := &ComposeProject{}
	err := c.kuladoClient.doById(COMPOSE_PROJECT_TYPE, id, resp)
...
func (c *ComposeProjectClient) Delete(container *ComposeProject) error {
	return c.kuladoClient.doResourceDelete(COMPOSE_PROJECT_TYPE, &container.Resource)
}
...
func (c *ComposeProjectClient) ActionCancelupgrade(resource *ComposeProject) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_PROJECT_TYPE, "cancelupgrade", &resource.Resource, nil, resp)
...
func (c *ComposeProjectClient) ActionCreate(resource *ComposeProject) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_PROJECT_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *ComposeProjectClient) ActionError(resource *ComposeProject) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_PROJECT_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *ComposeProjectClient) ActionFinishupgrade(resource *ComposeProject) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_PROJECT_TYPE, "finishupgrade", &resource.Resource, nil, resp)
...
func (c *ComposeProjectClient) ActionRemove(resource *ComposeProject) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_PROJECT_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *ComposeProjectClient) ActionRollback(resource *ComposeProject) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(COMPOSE_PROJECT_TYPE, "rollback", &resource.Resource, nil, resp)
