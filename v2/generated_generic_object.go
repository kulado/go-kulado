...
func newGenericObjectClient(kuladoClient *KuladoClient) *GenericObjectClient {
...
func (c *GenericObjectClient) ById(id string) (*GenericObject, error) {
	resp := &GenericObject{}
	err := c.kuladoClient.doById(GENERIC_OBJECT_TYPE, id, resp)
...
func (c *GenericObjectClient) Delete(container *GenericObject) error {
	return c.kuladoClient.doResourceDelete(GENERIC_OBJECT_TYPE, &container.Resource)
}
...
func (c *GenericObjectClient) ActionCreate(resource *GenericObject) (*GenericObject, error) {
	...
	err := c.kuladoClient.doAction(GENERIC_OBJECT_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *GenericObjectClient) ActionRemove(resource *GenericObject) (*GenericObject, error) {
	...
	err := c.kuladoClient.doAction(GENERIC_OBJECT_TYPE, "remove", &resource.Resource, nil, resp)
