...
func newAccountClient(kuladoClient *KuladoClient) *AccountClient {
...
func (c *AccountClient) Create(container *Account) (*Account, error) {
	resp := &Account{}
	err := c.kuladoClient.doCreate(ACCOUNT_TYPE, container, resp)
	return resp, err
}

func (c *AccountClient) Update(existing *Account, updates interface{}) (*Account, error) {
	resp := &Account{}
	err := c.kuladoClient.doUpdate(ACCOUNT_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *AccountClient) List(opts *ListOpts) (*AccountCollection, error) {
	resp := &AccountCollection{}
	err := c.kuladoClient.doList(ACCOUNT_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *AccountClient) ById(id string) (*Account, error) {
	resp := &Account{}
	err := c.kuladoClient.doById(ACCOUNT_TYPE, id, resp)
...
func (c *AccountClient) Delete(container *Account) error {
	return c.kuladoClient.doResourceDelete(ACCOUNT_TYPE, &container.Resource)
}
...
func (c *AccountClient) ActionActivate(resource *Account) (*Account, error) {
	...
	err := c.kuladoClient.doAction(ACCOUNT_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *AccountClient) ActionCreate(resource *Account) (*Account, error) {
	...
	err := c.kuladoClient.doAction(ACCOUNT_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *AccountClient) ActionDeactivate(resource *Account) (*Account, error) {
	...
	err := c.kuladoClient.doAction(ACCOUNT_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *AccountClient) ActionPurge(resource *Account) (*Account, error) {
	...
	err := c.kuladoClient.doAction(ACCOUNT_TYPE, "purge", &resource.Resource, nil, resp)
...
func (c *AccountClient) ActionRemove(resource *Account) (*Account, error) {
	...
	err := c.kuladoClient.doAction(ACCOUNT_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *AccountClient) ActionUpdate(resource *Account) (*Account, error) {
	...
	err := c.kuladoClient.doAction(ACCOUNT_TYPE, "update", &resource.Resource, nil, resp)
...
func (c *AccountClient) ActionUpgrade(resource *Account) (*Account, error) {
	...
	err := c.kuladoClient.doAction(ACCOUNT_TYPE, "upgrade", &resource.Resource, nil, resp)
