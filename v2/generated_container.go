...
func newContainerClient(kuladoClient *KuladoClient) *ContainerClient {
...
func (c *ContainerClient) Create(container *Container) (*Container, error) {
	resp := &Container{}
	err := c.kuladoClient.doCreate(CONTAINER_TYPE, container, resp)
	return resp, err
}

func (c *ContainerClient) Update(existing *Container, updates interface{}) (*Container, error) {
	resp := &Container{}
	err := c.kuladoClient.doUpdate(CONTAINER_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *ContainerClient) List(opts *ListOpts) (*ContainerCollection, error) {
	resp := &ContainerCollection{}
	err := c.kuladoClient.doList(CONTAINER_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *ContainerClient) ById(id string) (*Container, error) {
	resp := &Container{}
	err := c.kuladoClient.doById(CONTAINER_TYPE, id, resp)
...
func (c *ContainerClient) Delete(container *Container) error {
	return c.kuladoClient.doResourceDelete(CONTAINER_TYPE, &container.Resource)
}
...
func (c *ContainerClient) ActionAllocate(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "allocate", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionConsole(resource *Container, input *InstanceConsoleInput) (*InstanceConsole, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "console", &resource.Resource, input, resp)
...
func (c *ContainerClient) ActionCreate(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionDeallocate(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "deallocate", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionError(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionExecute(resource *Container, input *ContainerExec) (*HostAccess, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "execute", &resource.Resource, input, resp)
...
func (c *ContainerClient) ActionLogs(resource *Container, input *ContainerLogs) (*HostAccess, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "logs", &resource.Resource, input, resp)
...
func (c *ContainerClient) ActionMigrate(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "migrate", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionProxy(resource *Container, input *ContainerProxy) (*HostAccess, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "proxy", &resource.Resource, input, resp)
...
func (c *ContainerClient) ActionPurge(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "purge", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionRemove(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionRestart(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "restart", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionStart(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "start", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionStop(resource *Container, input *InstanceStop) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "stop", &resource.Resource, input, resp)
...
func (c *ContainerClient) ActionUpdate(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "update", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionUpdatehealthy(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "updatehealthy", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionUpdatereinitializing(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "updatereinitializing", &resource.Resource, nil, resp)
...
func (c *ContainerClient) ActionUpdateunhealthy(resource *Container) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(CONTAINER_TYPE, "updateunhealthy", &resource.Resource, nil, resp)
