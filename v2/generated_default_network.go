...
func newDefaultNetworkClient(kuladoClient *KuladoClient) *DefaultNetworkClient {
...
func (c *DefaultNetworkClient) ById(id string) (*DefaultNetwork, error) {
	resp := &DefaultNetwork{}
	err := c.kuladoClient.doById(DEFAULT_NETWORK_TYPE, id, resp)
...
func (c *DefaultNetworkClient) Delete(container *DefaultNetwork) error {
	return c.kuladoClient.doResourceDelete(DEFAULT_NETWORK_TYPE, &container.Resource)
}
...
func (c *DefaultNetworkClient) ActionActivate(resource *DefaultNetwork) (*Network, error) {
	...
	err := c.kuladoClient.doAction(DEFAULT_NETWORK_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *DefaultNetworkClient) ActionCreate(resource *DefaultNetwork) (*Network, error) {
	...
	err := c.kuladoClient.doAction(DEFAULT_NETWORK_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *DefaultNetworkClient) ActionDeactivate(resource *DefaultNetwork) (*Network, error) {
	...
	err := c.kuladoClient.doAction(DEFAULT_NETWORK_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *DefaultNetworkClient) ActionPurge(resource *DefaultNetwork) (*Network, error) {
	...
	err := c.kuladoClient.doAction(DEFAULT_NETWORK_TYPE, "purge", &resource.Resource, nil, resp)
...
func (c *DefaultNetworkClient) ActionRemove(resource *DefaultNetwork) (*Network, error) {
	...
	err := c.kuladoClient.doAction(DEFAULT_NETWORK_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *DefaultNetworkClient) ActionUpdate(resource *DefaultNetwork) (*Network, error) {
	...
	err := c.kuladoClient.doAction(DEFAULT_NETWORK_TYPE, "update", &resource.Resource, nil, resp)
