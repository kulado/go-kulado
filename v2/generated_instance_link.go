...
func newInstanceLinkClient(kuladoClient *KuladoClient) *InstanceLinkClient {
...
func (c *InstanceLinkClient) Create(container *InstanceLink) (*InstanceLink, error) {
	resp := &InstanceLink{}
	err := c.kuladoClient.doCreate(INSTANCE_LINK_TYPE, container, resp)
	return resp, err
}

func (c *InstanceLinkClient) Update(existing *InstanceLink, updates interface{}) (*InstanceLink, error) {
	resp := &InstanceLink{}
	err := c.kuladoClient.doUpdate(INSTANCE_LINK_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *InstanceLinkClient) List(opts *ListOpts) (*InstanceLinkCollection, error) {
	resp := &InstanceLinkCollection{}
	err := c.kuladoClient.doList(INSTANCE_LINK_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *InstanceLinkClient) ById(id string) (*InstanceLink, error) {
	resp := &InstanceLink{}
	err := c.kuladoClient.doById(INSTANCE_LINK_TYPE, id, resp)
...
func (c *InstanceLinkClient) Delete(container *InstanceLink) error {
	return c.kuladoClient.doResourceDelete(INSTANCE_LINK_TYPE, &container.Resource)
}
...
func (c *InstanceLinkClient) ActionActivate(resource *InstanceLink) (*InstanceLink, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_LINK_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *InstanceLinkClient) ActionCreate(resource *InstanceLink) (*InstanceLink, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_LINK_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *InstanceLinkClient) ActionDeactivate(resource *InstanceLink) (*InstanceLink, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_LINK_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *InstanceLinkClient) ActionPurge(resource *InstanceLink) (*InstanceLink, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_LINK_TYPE, "purge", &resource.Resource, nil, resp)
...
func (c *InstanceLinkClient) ActionRemove(resource *InstanceLink) (*InstanceLink, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_LINK_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *InstanceLinkClient) ActionUpdate(resource *InstanceLink) (*InstanceLink, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_LINK_TYPE, "update", &resource.Resource, nil, resp)
