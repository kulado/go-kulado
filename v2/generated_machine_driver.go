...
func newMachineDriverClient(kuladoClient *KuladoClient) *MachineDriverClient {
...
func (c *MachineDriverClient) ById(id string) (*MachineDriver, error) {
	resp := &MachineDriver{}
	err := c.kuladoClient.doById(MACHINE_DRIVER_TYPE, id, resp)
...
func (c *MachineDriverClient) Delete(container *MachineDriver) error {
	return c.kuladoClient.doResourceDelete(MACHINE_DRIVER_TYPE, &container.Resource)
}
...
func (c *MachineDriverClient) ActionActivate(resource *MachineDriver) (*MachineDriver, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_DRIVER_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *MachineDriverClient) ActionCreate(resource *MachineDriver) (*MachineDriver, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_DRIVER_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *MachineDriverClient) ActionDeactivate(resource *MachineDriver) (*MachineDriver, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_DRIVER_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *MachineDriverClient) ActionError(resource *MachineDriver) (*MachineDriver, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_DRIVER_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *MachineDriverClient) ActionReactivate(resource *MachineDriver) (*MachineDriver, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_DRIVER_TYPE, "reactivate", &resource.Resource, nil, resp)
...
func (c *MachineDriverClient) ActionRemove(resource *MachineDriver) (*MachineDriver, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_DRIVER_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *MachineDriverClient) ActionUpdate(resource *MachineDriver) (*MachineDriver, error) {
	...
	err := c.kuladoClient.doAction(MACHINE_DRIVER_TYPE, "update", &resource.Resource, nil, resp)
