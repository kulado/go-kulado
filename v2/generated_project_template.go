...
func newProjectTemplateClient(kuladoClient *KuladoClient) *ProjectTemplateClient {
...
func (c *ProjectTemplateClient) ById(id string) (*ProjectTemplate, error) {
	resp := &ProjectTemplate{}
	err := c.kuladoClient.doById(PROJECT_TEMPLATE_TYPE, id, resp)
...
func (c *ProjectTemplateClient) Delete(container *ProjectTemplate) error {
	return c.kuladoClient.doResourceDelete(PROJECT_TEMPLATE_TYPE, &container.Resource)
}
...
func (c *ProjectTemplateClient) ActionCreate(resource *ProjectTemplate) (*ProjectTemplate, error) {
	...
	err := c.kuladoClient.doAction(PROJECT_TEMPLATE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *ProjectTemplateClient) ActionRemove(resource *ProjectTemplate) (*ProjectTemplate, error) {
	...
	err := c.kuladoClient.doAction(PROJECT_TEMPLATE_TYPE, "remove", &resource.Resource, nil, resp)
