...
func newInstanceClient(kuladoClient *KuladoClient) *InstanceClient {
...
func (c *InstanceClient) Create(container *Instance) (*Instance, error) {
	resp := &Instance{}
	err := c.kuladoClient.doCreate(INSTANCE_TYPE, container, resp)
	return resp, err
}

func (c *InstanceClient) Update(existing *Instance, updates interface{}) (*Instance, error) {
	resp := &Instance{}
	err := c.kuladoClient.doUpdate(INSTANCE_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *InstanceClient) List(opts *ListOpts) (*InstanceCollection, error) {
	resp := &InstanceCollection{}
	err := c.kuladoClient.doList(INSTANCE_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *InstanceClient) ById(id string) (*Instance, error) {
	resp := &Instance{}
	err := c.kuladoClient.doById(INSTANCE_TYPE, id, resp)
...
func (c *InstanceClient) Delete(container *Instance) error {
	return c.kuladoClient.doResourceDelete(INSTANCE_TYPE, &container.Resource)
}
...
func (c *InstanceClient) ActionAllocate(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "allocate", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionConsole(resource *Instance, input *InstanceConsoleInput) (*InstanceConsole, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "console", &resource.Resource, input, resp)
...
func (c *InstanceClient) ActionCreate(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionDeallocate(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "deallocate", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionError(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionMigrate(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "migrate", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionPurge(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "purge", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionRemove(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionRestart(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "restart", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionStart(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "start", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionStop(resource *Instance, input *InstanceStop) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "stop", &resource.Resource, input, resp)
...
func (c *InstanceClient) ActionUpdate(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "update", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionUpdatehealthy(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "updatehealthy", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionUpdatereinitializing(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "updatereinitializing", &resource.Resource, nil, resp)
...
func (c *InstanceClient) ActionUpdateunhealthy(resource *Instance) (*Instance, error) {
	...
	err := c.kuladoClient.doAction(INSTANCE_TYPE, "updateunhealthy", &resource.Resource, nil, resp)
