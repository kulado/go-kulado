...
func newProcessPoolClient(kuladoClient *KuladoClient) *ProcessPoolClient {
...
func (c *ProcessPoolClient) Create(container *ProcessPool) (*ProcessPool, error) {
	resp := &ProcessPool{}
	err := c.kuladoClient.doCreate(PROCESS_POOL_TYPE, container, resp)
	return resp, err
}

func (c *ProcessPoolClient) Update(existing *ProcessPool, updates interface{}) (*ProcessPool, error) {
	resp := &ProcessPool{}
	err := c.kuladoClient.doUpdate(PROCESS_POOL_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *ProcessPoolClient) List(opts *ListOpts) (*ProcessPoolCollection, error) {
	resp := &ProcessPoolCollection{}
	err := c.kuladoClient.doList(PROCESS_POOL_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *ProcessPoolClient) ById(id string) (*ProcessPool, error) {
	resp := &ProcessPool{}
	err := c.kuladoClient.doById(PROCESS_POOL_TYPE, id, resp)
...
func (c *ProcessPoolClient) Delete(container *ProcessPool) error {
	return c.kuladoClient.doResourceDelete(PROCESS_POOL_TYPE, &container.Resource)
}
