...
func newUserPreferenceClient(kuladoClient *KuladoClient) *UserPreferenceClient {
...
func (c *UserPreferenceClient) ById(id string) (*UserPreference, error) {
	resp := &UserPreference{}
	err := c.kuladoClient.doById(USER_PREFERENCE_TYPE, id, resp)
...
func (c *UserPreferenceClient) Delete(container *UserPreference) error {
	return c.kuladoClient.doResourceDelete(USER_PREFERENCE_TYPE, &container.Resource)
}
...
func (c *UserPreferenceClient) ActionActivate(resource *UserPreference) (*UserPreference, error) {
	...
	err := c.kuladoClient.doAction(USER_PREFERENCE_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *UserPreferenceClient) ActionCreate(resource *UserPreference) (*UserPreference, error) {
	...
	err := c.kuladoClient.doAction(USER_PREFERENCE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *UserPreferenceClient) ActionDeactivate(resource *UserPreference) (*UserPreference, error) {
	...
	err := c.kuladoClient.doAction(USER_PREFERENCE_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *UserPreferenceClient) ActionPurge(resource *UserPreference) (*UserPreference, error) {
	...
	err := c.kuladoClient.doAction(USER_PREFERENCE_TYPE, "purge", &resource.Resource, nil, resp)
...
func (c *UserPreferenceClient) ActionRemove(resource *UserPreference) (*UserPreference, error) {
	...
	err := c.kuladoClient.doAction(USER_PREFERENCE_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *UserPreferenceClient) ActionUpdate(resource *UserPreference) (*UserPreference, error) {
	...
	err := c.kuladoClient.doAction(USER_PREFERENCE_TYPE, "update", &resource.Resource, nil, resp)
