...
func newStackClient(kuladoClient *KuladoClient) *StackClient {
	return &StackClient{
		kuladoClient: kuladoClient,
	}
}
...
func (c *StackClient) Create(container *Stack) (*Stack, error) {
	resp := &Stack{}
	err := c.kuladoClient.doCreate(STACK_TYPE, container, resp)
	return resp, err
}

func (c *StackClient) Update(existing *Stack, updates interface{}) (*Stack, error) {
	resp := &Stack{}
	err := c.kuladoClient.doUpdate(STACK_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *StackClient) List(opts *ListOpts) (*StackCollection, error) {
	resp := &StackCollection{}
	err := c.kuladoClient.doList(STACK_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *StackClient) ById(id string) (*Stack, error) {
	resp := &Stack{}
	err := c.kuladoClient.doById(STACK_TYPE, id, resp)
...
func (c *StackClient) Delete(container *Stack) error {
	return c.kuladoClient.doResourceDelete(STACK_TYPE, &container.Resource)
}
...
func (c *StackClient) ActionActivateservices(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "activateservices", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionAddoutputs(resource *Stack, input *AddOutputsInput) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "addoutputs", &resource.Resource, input, resp)
...
func (c *StackClient) ActionCancelupgrade(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "cancelupgrade", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionCreate(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionDeactivateservices(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "deactivateservices", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionError(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "error", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionExportconfig(resource *Stack, input *ComposeConfigInput) (*ComposeConfig, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "exportconfig", &resource.Resource, input, resp)
...
func (c *StackClient) ActionFinishupgrade(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "finishupgrade", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionRemove(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionRollback(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "rollback", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionUpdate(resource *Stack) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "update", &resource.Resource, nil, resp)
...
func (c *StackClient) ActionUpgrade(resource *Stack, input *StackUpgrade) (*Stack, error) {
	...
	err := c.kuladoClient.doAction(STACK_TYPE, "upgrade", &resource.Resource, input, resp)
