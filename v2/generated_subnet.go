...
func (c *SubnetClient) ActionActivate(resource *Subnet) (*Subnet, error) {
	...
	err := c.kuladoClient.doAction(SUBNET_TYPE, "activate", &resource.Resource, nil, resp)
...
func (c *SubnetClient) ActionDeactivate(resource *Subnet) (*Subnet, error) {
	...
	err := c.kuladoClient.doAction(SUBNET_TYPE, "deactivate", &resource.Resource, nil, resp)
...
func (c *SubnetClient) ActionPurge(resource *Subnet) (*Subnet, error) {
	...
	err := c.kuladoClient.doAction(SUBNET_TYPE, "purge", &resource.Resource, nil, resp)
...
func (c *SubnetClient) ActionUpdate(resource *Subnet) (*Subnet, error) {
	...
	err := c.kuladoClient.doAction(SUBNET_TYPE, "update", &resource.Resource, nil, resp)
