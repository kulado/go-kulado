...
func newHostTemplateClient(kuladoClient *KuladoClient) *HostTemplateClient {
...
func (c *HostTemplateClient) Create(container *HostTemplate) (*HostTemplate, error) {
	resp := &HostTemplate{}
	err := c.kuladoClient.doCreate(HOST_TEMPLATE_TYPE, container, resp)
	return resp, err
}

func (c *HostTemplateClient) Update(existing *HostTemplate, updates interface{}) (*HostTemplate, error) {
	resp := &HostTemplate{}
	err := c.kuladoClient.doUpdate(HOST_TEMPLATE_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *HostTemplateClient) List(opts *ListOpts) (*HostTemplateCollection, error) {
	resp := &HostTemplateCollection{}
	err := c.kuladoClient.doList(HOST_TEMPLATE_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *HostTemplateClient) ById(id string) (*HostTemplate, error) {
	resp := &HostTemplate{}
	err := c.kuladoClient.doById(HOST_TEMPLATE_TYPE, id, resp)
...
func (c *HostTemplateClient) Delete(container *HostTemplate) error {
	return c.kuladoClient.doResourceDelete(HOST_TEMPLATE_TYPE, &container.Resource)
}
...
func (c *HostTemplateClient) ActionCreate(resource *HostTemplate) (*HostTemplate, error) {
	...
	err := c.kuladoClient.doAction(HOST_TEMPLATE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *HostTemplateClient) ActionRemove(resource *HostTemplate) (*HostTemplate, error) {
	...
	err := c.kuladoClient.doAction(HOST_TEMPLATE_TYPE, "remove", &resource.Resource, nil, resp)
