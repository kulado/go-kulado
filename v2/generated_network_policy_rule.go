...
func newNetworkPolicyRuleClient(kuladoClient *KuladoClient) *NetworkPolicyRuleClient {
...
func (c *NetworkPolicyRuleClient) ById(id string) (*NetworkPolicyRule, error) {
	resp := &NetworkPolicyRule{}
	err := c.kuladoClient.doById(NETWORK_POLICY_RULE_TYPE, id, resp)
...
func (c *NetworkPolicyRuleClient) Delete(container *NetworkPolicyRule) error {
	return c.kuladoClient.doResourceDelete(NETWORK_POLICY_RULE_TYPE, &container.Resource)
}
