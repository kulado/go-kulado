...
func newSecretClient(kuladoClient *KuladoClient) *SecretClient {
	return &SecretClient{
		kuladoClient: kuladoClient,
	}
}
...
func (c *SecretClient) Create(container *Secret) (*Secret, error) {
	resp := &Secret{}
	err := c.kuladoClient.doCreate(SECRET_TYPE, container, resp)
	return resp, err
}

func (c *SecretClient) Update(existing *Secret, updates interface{}) (*Secret, error) {
	resp := &Secret{}
	err := c.kuladoClient.doUpdate(SECRET_TYPE, &existing.Resource, updates, resp)
	return resp, err
}

func (c *SecretClient) List(opts *ListOpts) (*SecretCollection, error) {
	resp := &SecretCollection{}
	err := c.kuladoClient.doList(SECRET_TYPE, opts, resp)
	resp.client = c
	return resp, err
}
...
func (c *SecretClient) ById(id string) (*Secret, error) {
	resp := &Secret{}
	err := c.kuladoClient.doById(SECRET_TYPE, id, resp)
...
func (c *SecretClient) Delete(container *Secret) error {
	return c.kuladoClient.doResourceDelete(SECRET_TYPE, &container.Resource)
}
...
func (c *SecretClient) ActionCreate(resource *Secret) (*Secret, error) {
	...
	err := c.kuladoClient.doAction(SECRET_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *SecretClient) ActionRemove(resource *Secret) (*Secret, error) {
	...
	err := c.kuladoClient.doAction(SECRET_TYPE, "remove", &resource.Resource, nil, resp)
