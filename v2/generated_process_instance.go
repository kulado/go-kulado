...
func newProcessInstanceClient(kuladoClient *KuladoClient) *ProcessInstanceClient {
...
func (c *ProcessInstanceClient) ById(id string) (*ProcessInstance, error) {
	resp := &ProcessInstance{}
	err := c.kuladoClient.doById(PROCESS_INSTANCE_TYPE, id, resp)
...
func (c *ProcessInstanceClient) Delete(container *ProcessInstance) error {
	return c.kuladoClient.doResourceDelete(PROCESS_INSTANCE_TYPE, &container.Resource)
}
...
func (c *ProcessInstanceClient) ActionReplay(resource *ProcessInstance) (*ProcessInstance, error) {
	...
	err := c.kuladoClient.doAction(PROCESS_INSTANCE_TYPE, "replay", &resource.Resource, nil, resp)
