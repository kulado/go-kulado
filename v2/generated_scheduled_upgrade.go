...
func newScheduledUpgradeClient(kuladoClient *KuladoClient) *ScheduledUpgradeClient {
...
func (c *ScheduledUpgradeClient) ById(id string) (*ScheduledUpgrade, error) {
	resp := &ScheduledUpgrade{}
	err := c.kuladoClient.doById(SCHEDULED_UPGRADE_TYPE, id, resp)
...
func (c *ScheduledUpgradeClient) Delete(container *ScheduledUpgrade) error {
	return c.kuladoClient.doResourceDelete(SCHEDULED_UPGRADE_TYPE, &container.Resource)
}
...
func (c *ScheduledUpgradeClient) ActionCreate(resource *ScheduledUpgrade) (*ScheduledUpgrade, error) {
	...
	err := c.kuladoClient.doAction(SCHEDULED_UPGRADE_TYPE, "create", &resource.Resource, nil, resp)
...
func (c *ScheduledUpgradeClient) ActionRemove(resource *ScheduledUpgrade) (*ScheduledUpgrade, error) {
	...
	err := c.kuladoClient.doAction(SCHEDULED_UPGRADE_TYPE, "remove", &resource.Resource, nil, resp)
...
func (c *ScheduledUpgradeClient) ActionStart(resource *ScheduledUpgrade) (*ScheduledUpgrade, error) {
	...
	err := c.kuladoClient.doAction(SCHEDULED_UPGRADE_TYPE, "start", &resource.Resource, nil, resp)
